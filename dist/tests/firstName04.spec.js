...
(0, test_1.test)('Verify first name field is mandatory', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
    ...
    // Fill the form WITHOUT first name, keep others valid
    yield (0, fillUserProfile_1.fillUserProfile)(userProfile, { firstName: "" });
    ...
    (0, test_1.expect)(dialogMessage).toContain("First name must be filled out");
}));
