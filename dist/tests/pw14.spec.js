...
(0, test_1.test)('Verify password rejects less than minimum characters (e.g., 6)', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
    ...
    yield (0, fillUserProfile_1.fillUserProfile)(userProfile, { password: "Password1", confirmPassword: "Password1" });
    ...
    (0, test_1.expect)(dialogMessage).toContain("Password must contain a special character");
}));
