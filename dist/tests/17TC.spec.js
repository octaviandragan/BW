...
(0, test_1.test)('Verify password rejects less than minimum characters (e.g., 6)', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
    ...
    yield (0, fillUserProfile_1.fillUserProfile)(userProfile, { password: "P@ssw0rd!", confirmPassword: "WrongPass" });
    ...
    (0, test_1.expect)(dialogMessage).toContain("Passwords do not match");
}));
