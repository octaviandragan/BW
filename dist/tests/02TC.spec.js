...
(0, test_1.test)('Verify last name does not accept numbers', (_a) => __awaiter(void 0, [_a], void 0, function* ({ page }) {
    ...
    yield (0, fillUserProfile_1.fillUserProfile)(userProfile, { firstName: "John123" });
    ...
    (0, test_1.expect)(dialogMessage).toContain("First name must contain alphabetical characters only");
}));
